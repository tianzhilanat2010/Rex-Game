...
namespace RexEngine
{
	...
	public class Projectile:RexObject
	{
		...
		[HideInInspector]
		public RexPool parentSpawnPool; //If this is spawned via a RexPool, set this to the pool that spawned it; this will enable it to despawn from the same pool
